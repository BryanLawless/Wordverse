<template>
	<div class="texture">
		<router-view v-slot="{ Component, route }">
			<div
				class="flex flex-col justify-center gap-4 h-screen"
				:class="designStore.showBanner == true ? 'items-center' : null">
				<div
					v-if="designStore.showBanner == true && route.name !== '404'"
				...
				<transition v-if="state.serverAvailable" name="page-fade" mode="in-out">
					<div :key:="route.name">
